...
class Dashboardbse extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      loading: true,
  ...
  componentDidMount = () => {
    ...
    if (this.props.company !== "sp500") {
      this.setState({ company: this.props.company }, () => {
        axios
          .get("/api/stockdetailsbse?company=" + this.state.company)
          .then((s) => {
            if (s.status === 200) {
...
export default withStyles(styles, { withTheme: true })(Dashboardbse);
