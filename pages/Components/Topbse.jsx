...
class Topbse extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      loading: false,
            ...
            {this.state.topCompanies.map((company) => {
              return (
                <NavLink
                  ...
                  key={uuidv4()}
                  to={{
                    pathname: "/companydetailsbse/" + company,
                  }}
                >
                  <Paper
                    elevation={0}
...
export default withStyles(styles, { withTheme: true })(Topbse);
