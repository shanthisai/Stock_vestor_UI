...
class Simulationbse extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      selectedCompany: "",
  ...
  onSelectDays = (e) => {
    ...
    axios
      .get("/api/simulationtopbse" + "?" + "days=" + days)
      .then((s) => {
        console.log(s.data);
        if (s.status === 200) {
...
export default withStyles(styles, { withTheme: true })(Simulationbse);
